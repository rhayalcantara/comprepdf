...
CREATE TABLE IF NOT EXISTS compression_jobs (
    ...
    operation_type ENUM('compress', 'split', 'merge', 'sign', 'extract', 'rotate', 'protect', 'unlock', 'certificate', 'form_generate', 'pdf_edit', 'organize', 'convert') NOT NULL DEFAULT 'compress',
